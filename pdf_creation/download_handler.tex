...
\node[anchor=west, %anchor is upper left corner of the graphic
      ...
      yshift=0cm] 
     at (current page.west) %left upper corner of the page
     {\includegraphics[width=\paperwidth,height=\paperheight]{New Images/bot2.png}}; 
\end{tikzpicture}
...
\node[anchor=west, %anchor is upper left corner of the graphic
      ...
      yshift=0cm] 
     at (current page.west) %left upper corner of the page
     {\includegraphics[width=\paperwidth,height=\paperheight]{New Images/middle3.png}}; 
\end{tikzpicture}
...
\node[anchor=west, %anchor is upper left corner of the graphic
      ...
      yshift=0cm] 
     at (current page.west) %left upper corner of the page
     {\includegraphics[width=\paperwidth,height=\paperheight]{New Images/top4.png}}; 
\end{tikzpicture}
...
\begin{center}\includegraphics{download_handler_files/figure-latex/unnamed-chunk-1-1} \end{center}
    }{{}}

    \ffigbox[5cm][]{%

\begin{center}\includegraphics{download_handler_files/figure-latex/unnamed-chunk-2-1} \end{center}
    }{{}}
    
    \ffigbox[5.2cm][]{%

\begin{center}\includegraphics{download_handler_files/figure-latex/unnamed-chunk-3-1} \end{center}
    }{{}}
...
\begin{center}\includegraphics{download_handler_files/figure-latex/unnamed-chunk-4-1} \end{center}
    }{{}}

    \ffigbox[5cm][]{%

\begin{center}\includegraphics{download_handler_files/figure-latex/unnamed-chunk-5-1} \end{center}
    }{{}}
    
    \ffigbox[5.2cm][]{%

\begin{center}\includegraphics{download_handler_files/figure-latex/unnamed-chunk-6-1} \end{center}
    }{{}}
